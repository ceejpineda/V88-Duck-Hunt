const duckHunt = (()=>{
    ...
    return {initialize, gameStart, winOrLose, spawnBasicBirdsL, spawnBasicBirdsR, spawnNormalBirdsL, spawnHardBird, birdMovementsL, birdMovementsR}
...
setInterval(duckHunt.spawnBasicBirdsL, 2000);
setInterval(duckHunt.spawnBasicBirdsR, 4000);
setInterval(duckHunt.spawnNormalBirdsL, 3000);
setInterval(duckHunt.spawnHardBird, 3000);
setInterval(duckHunt.birdMovementsL, 5);
setInterval(duckHunt.birdMovementsR, 5);
setInterval(duckHunt.winOrLose, 5);
